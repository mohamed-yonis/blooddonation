...
if(demo[3].value==demo[3].value){
    result[3].style.display="none";
    return false;
}
if(demo[4].value<0){
    alert("A Negative Number Is Not Allowed");
...
if(demo[4].value<18){
    result[4].innerHTML= "Less Than 18 Years Old Cannot Donate ";
     demo[4].focus();
     return false;
 }
 if(demo[4].value==demo[4].value){
    result[4].style.display="none";
    return false;
}
if(demo[5].value<0){
    alert("A Negative Number Is Not Allowed");
...
if(demo[5].value==demo[5].value){
    result[5].style.display="none";
    return false;
}
if(demo[6].value==""){
...
if(demo[6].value==demo[6].value){
    result[6].style.display="none";
    return false;
}
if(demo[9].value==""){
...
if(demo[9].value==demo[9].value){
    result[9].style.display="none";
    return false;
}
else{
 location="real.html";
